	...
	public RunDataServiceMockup(RunInformationService runInformationService) {
		...
		if (runData == null || runData.isEmpty()) {
			...
			runData.add(runInformationService
					.save(new RunInformation("Donkey Kong Country Returns", "Any%", "Wii", "michael_1985", "michael_1985x", "1:35:00")));
			runData.add(runInformationService
					.save(new RunInformation("Donkey Kong Country: Tropical Freeze", "Any% WiiU", "WiiU", "Mr.Tiger", "mrtiger92", "2:00:00")));
			runData.add(runInformationService
					.save(new RunInformation("Cornerstone: The Song of Tyrim", "Any% No Credits Skip", "PC", "Multiwinner", "Multiwinner", "28:00")));
			runData.add(runInformationService
					.save(new RunInformation("Donkey Kong Country Returns", "100%", "Wii", "Mr.Tiger", "mrtiger92", "2:40:00")));
			runData.add(runInformationService
					.save(new RunInformation("Xenoblade Chronicles", "Any% NG", "WiiU", "docmob", "docmob", "5:30:00")));
			runData.add(runInformationService.save(new RunInformation("140", "Any%", "PC", "Zet", "Zet237", "20:00")));
		}
